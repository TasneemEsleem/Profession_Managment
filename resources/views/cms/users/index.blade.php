...
<div class="content-wrapper">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            ...
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">{{__('cms.Users')}}</h2>
                ...
                <table class="table data-thumb-view dataTable no-footer" id="DataTables_Table_0" role="grid">
                    ...
                    <tbody>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td>
                                <div>
                                    <div class="badge @if ($user->status) bg-success @else  bg-danger
                                    @endif">{{$user->status}}</div>
                                </div>
                            </td>
                            <td style="width: 166.9062px;">
                                <a href="{{route('users.edit', $user->id)}}" class="btn btn-info btn-sm-flat">
                                    <i class="feather icon-edit" style="font-size: 18px;"></i></a>
                                <a href="#" onclick="confirmDelete('{{$user->id}}', this)"  class="btn btn-danger btn-sm-flat">
