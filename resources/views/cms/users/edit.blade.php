    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">{{__('cms.Edit-User')}}</h2>
                ...
                <div class="col-md-12 col-12">
                    <div class="card" style="height: 501.406px;">
                        <div class="card-header">
                            <h4 class="card-title">{{__('cms.Edit-User')}}</h4>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input type="text" id="name" class="form-control" placeholder="{{__('cms.EnterUserName')}}" value="{{$user->name}}">
                                            ...
                                            <div class="col-sm-8 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input type="email" id="email" class="form-control" placeholder="{{__('cms.Email')}}" value="{{$user->email}}">
                                                        <div class="form-control-position">
                                            ...
                                            <div class="col-sm-8 col-12">
                                                <div class="custom-control custom-switch mr-2 mb-1">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="status" @if ($user->status) checked
                                                    @endif>
                                            ...
                                            <div class="col-12">
                                                <button type="button" onclick="performUpdate('{{$user->id}}')" class="btn btn-primary mr-1 mb-1 waves-effect waves-light">{{__('cms.Save')}}</button>
...
<script>
    function performUpdate(id) {
        ...
        axios.put('/cms/users/{{$user->id}}', data)
