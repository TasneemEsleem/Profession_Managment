                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('categories.create')}}">{{__('cms.Create-Category')}}</a>
                            </li>
                        </ol>
                    </div>
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input type="text" id="name_ar" class="form-control" placeholder="{{__('cms.EnterNameCategory')}}">
                                            ...
                                            <div class="col-sm-8 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input type="text" id="name_en" class="form-control" placeholder="{{__('cms.EnterNameCategory')}}">
                                                        <div class="form-control-position">
                                                            <i class="feather icon-user"></i>
                                                        </div>
                                                    </div>
...
<script>
    function performStore() {
        ...
        axios.post('/cms/categories', data)
