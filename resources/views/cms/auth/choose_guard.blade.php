                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 p-2">
                                        ...
                                        <p class="px-2">{{__('cms.choosregisteruser')}}.</p>
                                        <div class="card-content">
                                            <div class="card-body p-2">
                                                <a href="{{route('cms.register')}}" class="btn btn-primary top-100 start-50 translate-middle float-left btn-inline mb-200">{{__('cms.profession')}}</a>
                                            </div>
                                            <div class="card-body p-2">
                                                <a href="{{route('cms.register-user')}}" class="btn btn-primary float-left btn-inline mb-300">{{__('cms.custumer')}}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
