                ...
                <table class="table data-thumb-view dataTable no-footer" id="DataTables_Table_0" role="grid">
                    ...
                    <tbody>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td>
                            <a href="{{route('role.edit-permission' , $role->id)}}" class="btn btn-info mr-1 mb-1 waves-effect waves-light">
                               
                                <span class="badge bg-danger">{{$role->permissions_count}}</span>
                                 {{__('cms.Permissions')}}</a>
                            </td>
                            <td><span class="badge bg-success">{{$role->guard_name}}</span></td>
                            <td style="width: 166.9062px;">
                                <a href="{{route('roles.edit', $role->id)}}" class="btn btn-info btn-sm-flat">
                                    <i class="feather icon-edit" style="font-size: 18px;"></i></a>
                                <a href="#" onclick="confirmDelete('{{$role->id}}', this)"  class="btn btn-danger btn-sm-flat">
