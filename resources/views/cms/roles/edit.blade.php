    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">{{__('cms.Edit-Role')}}</h2>
                ...
                <div class="col-md-12 col-12">
                    <div class="card" style="height: 501.406px;">
                        <div class="card-header">
                            <h4 class="card-title">{{__('cms.Edit-Role')}}</h4>
                        </div>
                                ...
                                <form class="form form-vertical">
                                    <div class="form-body">
                                        ...
                                        <div class="col-sm-8 col-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group data-select2-id=126">
                                                        <select class="form-control select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true" id="guard">
                                                            ...
                                                            <option value="profession"@selected($role->guard_name == 'profession')>Profession</option>
                                            ...
                                            <div class="col-12">
                                                <button type="button" onclick="performUpdate('{{$role->id}}')" class="btn btn-primary mr-1 mb-1 waves-effect waves-light">{{__('cms.Save_changes')}}</button>
...
<script>
    function performUpdate(id) {
        ...
        axios.put('/cms/roles/{{$role->id}}', data)
