    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">{{__('cms.Create-Project')}}</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('projects.create')}}">{{__('cms.Create-Project')}}</a>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card" style="height: 501.406px;">
                        <div class="card-header">
                            <h4 class="card-title">{{__('cms.Create-Project')}}</h4>
                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="duration_date" value="" class="form-control" placeholder="{{__('cms.duration date')}}">
                                                    </div>
                                                </div>
                                            <div class="col-sm-4 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input type="text" id="price" class="form-control" placeholder="{{__('cms.price')}}">
                                                    </div>
                                                </div>
                                            </div>
