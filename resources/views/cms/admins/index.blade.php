...
<div class="content-wrapper">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            ...
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">{{__('cms.Admins')}}</h2>
                ...
                <table class="table data-thumb-view dataTable no-footer" id="DataTables_Table_0" role="grid">
                    ...
                    <tbody>
                        ...
                        <tr role="row" class="odd">
                            ...
                            @if ($admin->image == null)
                            <img src="{{asset('cms/app-assets/images/portrait/small/avatar-s-11.jpg')}}" alt="Img placeholder">
                            @else
                            ...
                            <td>
                                <div>
                                    <div class="badge @if ($admin->status) bg-success @else  bg-danger
                                    @endif">{{$admin->status}}</div>
                                </div>
                            </td>
                            <td style="width: 166.9062px;">
                                <a href="{{route('admins.edit', $admin->id)}}" class="btn btn-info btn-sm-flat">
                                    <i class="feather icon-edit" style="font-size: 18px;"></i></a>
                                <a href="#" onclick="confirmDelete('{{$admin->id}}', this)"  class="btn btn-danger btn-sm-flat">
