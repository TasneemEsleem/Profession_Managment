...
<div class="content-wrapper">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            ...
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">{{__('cms.Skill')}}</h2>
                ...
                <table class="table data-thumb-view dataTable no-footer" id="DataTables_Table_0" role="grid">
                    <thead>
                        <tr role="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="skill: activate to sort column ascending">{{__('cms.name_en')}}</th>
                    ...
                    <tbody>
                        ...
                        <tr role="row" class="odd">
                            <td>{{$loop->index +1}}</td>
                            <td class="product-name">{{$skill->name_ar}}</td>
                            <td class="product-skill">{{$skill->name_en}}</td>
                            <td>
                                <div>
                                    <div class="badge @if ($skill->status) bg-success @else  bg-danger
                                    @endif">{{$skill->status}}</div>
                                </div>
                            </td>
                            <td style="width: 166.9062px;">
                                <a href="{{route('skills.edit', $skill->id)}}" class="btn btn-info btn-sm-flat">
                                    <i class="feather icon-edit" style="font-size: 18px;"></i></a>
                                <a href="#" onclick="confirmDelete('{{$skill->id}}', this)" class="btn btn-danger btn-sm-flat">
