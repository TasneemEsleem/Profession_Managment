    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">{{__('cms.Create-Category')}}</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('subcategories.create')}}">{{__('cms.Create-SubCategory')}}</a>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card" style="height: 501.406px;">
                        <div class="card-header">
                            <h4 class="card-title">{{__('cms.Create-Category')}}</h4>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input type="text" id="name_ar" class="form-control" placeholder="{{__('cms.EnterNameSubCategory')}}">
                                            ...
                                            <div class="col-sm-8 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input type="text" id="name_en" class="form-control" placeholder="{{__('cms.EnterNameSubCategory')}}">
                                                        <div class="form-control-position">
                                                            <i class="feather icon-user"></i>
                                                        </div>
                                                    </div>
...
<script>
    function performStore() {
        ...
        axios.post('/cms/subcategories', data)
